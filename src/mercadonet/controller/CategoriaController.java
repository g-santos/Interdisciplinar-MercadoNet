...
public class CategoriaController {
	...
	public CategoriaController(int idcategoria, String nome) {
	...
	public static CategoriaController pesquisarCategoriaid(int categoriaid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			rs = stmt.executeQuery();
			CategoriaController categoria = null;
			while (rs.next()) {
				categoria = new CategoriaController(rs.getInt("ID_CATEGORIA"), rs.getString("NOME"));
			}
			return categoria;
		} catch (ClassNotFoundException Except) {
			// TODO Auto-generated catch block
