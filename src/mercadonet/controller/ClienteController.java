...
public class ClienteController {
	...
	public ClienteController(int idcliente, String nome, String cpf, String endereco, String cep, String email, String telefone) {
	...
	public static ClienteController pesquisarCliente(String clientenome) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			while (rs.next()) {
				cliente = new ClienteController(rs.getInt("ID_CLIENTE"), rs.getString("NOME"), rs.getString("CPF"),
	...
	public static ClienteController pesquisarClienteid(int clienteid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
	...
	public static void alterarCliente() throws Exception {
		...
		ClienteController c = pesquisarClienteid(idcliente);
