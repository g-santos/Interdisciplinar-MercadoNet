...
public class ClienteModel {
	...
	public ClienteModel(int idcliente, String nome, String cpf, String endereco, String cep, String email, String telefone) {
	...
	public static ClienteModel pesquisarCliente(String clientenome) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			while (rs.next()) {
				cliente = new ClienteModel(rs.getInt("ID_CLIENTE"), rs.getString("NOME"), rs.getString("CPF"),
	...
	public static ClienteModel pesquisarClienteid(int clienteid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
	...
	public static void alterarCliente() throws Exception {
		...
		ClienteModel c = pesquisarClienteid(idcliente);
