...
public class ProdutoModel {
	...
	public ProdutoModel(int idproduto, String nome, String marcaprod, double preco, CategoriaModel categoria) {
	...
	public static ProdutoModel pesquisarProduto(String produtonome) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			while (rs.next()) {
				produto = new ProdutoModel(rs.getInt("ID_PRODUTO"), rs.getString("NOME"), rs.getString("MARCAPROD"),
						rs.getDouble("PRECO"), CategoriaModel.pesquisarCategoriaid(rs.getInt("ID_CATEGORIA")));
			}
			return produto;
		} catch (ClassNotFoundException Except) {
			// TODO Auto-generated catch block
	...
	public static ProdutoModel pesquisarProdutoid(int produtoid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
	...
	public static void alterarProduto() throws Exception {
		...
		ProdutoModel p = pesquisarProdutoid(idproduto);
