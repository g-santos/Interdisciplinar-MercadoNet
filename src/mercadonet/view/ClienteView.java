...
public class ClienteView {
	...
	public ClienteView(int idcliente, String nome, String cpf, String endereco, String cep, String email, String telefone) {
	...
	public static ClienteView pesquisarCliente(String clientenome) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			while (rs.next()) {
				cliente = new ClienteView(rs.getInt("ID_CLIENTE"), rs.getString("NOME"), rs.getString("CPF"),
	...
	public static ClienteView pesquisarClienteid(int clienteid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
	...
	public static void alterarCliente() throws Exception {
		...
		ClienteView c = pesquisarClienteid(idcliente);
