...
public class CategoriaView {
	...
	public CategoriaView(int idcategoria, String nome) {
	...
	public static CategoriaView pesquisarCategoriaid(int categoriaid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			rs = stmt.executeQuery();
			CategoriaView categoria = null;
			while (rs.next()) {
				categoria = new CategoriaView(rs.getInt("ID_CATEGORIA"), rs.getString("NOME"));
			}
			return categoria;
		} catch (ClassNotFoundException Except) {
			// TODO Auto-generated catch block
