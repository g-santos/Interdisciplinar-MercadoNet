...
public class ProdutoView {
	...
	public ProdutoView(int idproduto, String nome, String marcaprod, double preco, CategoriaView categoria) {
	...
	public static ProdutoView pesquisarProduto(String produtonome) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
			...
			rs = stmt.executeQuery();
			ProdutoView produto = null;
			while (rs.next()) {
				produto = new ProdutoView(rs.getInt("ID_PRODUTO"), rs.getString("NOME"), rs.getString("MARCAPROD"),
						rs.getDouble("PRECO"), CategoriaView.pesquisarCategoriaid(rs.getInt("ID_CATEGORIA")));
			}
			return produto;
		} catch (ClassNotFoundException Except) {
			// TODO Auto-generated catch block
	...
	public static ProdutoView pesquisarProdutoid(int produtoid) throws SQLException {
		Connection conn;
		try {
			conn = Conexao.getConnection();
			PreparedStatement stmt;
	...
	public static void alterarProduto() throws Exception {
		...
		ProdutoView p = pesquisarProdutoid(idproduto);
